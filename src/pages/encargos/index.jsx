        ...
        <div className="card">
            ...
            <div className="card-body">
                ...
                <div className="tab-content pt-2" id="borderedTabContent">
                    <div className="tab-pane fade show active" id="encargos" role="tabpanel" aria-labelledby="encargos-tab">
                        <Encargos />
                    </div>
                    <div className="tab-pane fade" id="calendario" role="tabpanel" aria-labelledby="calendario-tab">
                        <Calendario />
                    </div>
                </div>
            </div>
